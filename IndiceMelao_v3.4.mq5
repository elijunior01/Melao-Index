...
//|              Índice Melão (MeI) — Calculadora v3.4              |
//|                                                                  |
...
//|                                                                  |
//| IMPORTANTE                                                        |
//| O MDD medido nesta v3.4 é o MDD da série histórica de equity      |
...
void OnStart()
{
   Print("=== Índice Melão v3.4 iniciado ===");
   ...
   string rel="";
   rel+="RELATÓRIO DO ÍNDICE MELÃO (MeI) v3.4\n";
   rel+="==============================================\n";
   ...
   rel+="1. O MDD desta versão é o MDD da série histórica reconstruída nos pontos disponíveis.\n";
   rel+="2. Não é um MDD tick-a-tick completo da equity flutuante intratrade.\n";
   rel+="3. Benchmark é opcional e usa somente o último candle fechado disponível até cada ponto.\n";
   rel+="4. A estimativa Bayesiana é uma operacionalização da Seção VII, não uma distribuição universal garantida.\n";
   rel+="5. CV e sugestão de topK são diagnósticos heurísticos adicionais.\n";
   ...
   if(gravarArquivo)
   {
      string nome_arq="IndiceMelao_v3.4_resultado.txt";
   ...
   if(gravarCSVHistorico)
   {
      ...
      GravarCSVHistorico(csv,T,R,R_periodo,maior_mdd,MDDstar,MeI,
                         ...
                         modo_serie==MODO_TEMPORAL?"temporal":"por_deal");
   }

   Print("=== Índice Melão v3.4 finalizado ===");
}
